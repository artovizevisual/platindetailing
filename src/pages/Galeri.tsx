...
import audiS3Red2 from "@/assets/gallery/audi-s3-red-2.jpg";
...
const galleryItems = [
  ...
  { id: 29, category: "seramik", src: audiS3Red2, alt: "Audi S3 Kırmızı Seramik" },
  { id: 30, category: "seramik", src: porscheCayenneWhite, alt: "Porsche Cayenne Seramik" },
